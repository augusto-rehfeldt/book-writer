...
class InitStep(BaseStep):
    ...
    def execute(self) -> Dict[str, Any]:
        ...
        # Get target length in words, then convert to pages for downstream steps
        target_word_count = self._get_word_count(is_series)
        page_count = calculate_page_count(target_word_count)
